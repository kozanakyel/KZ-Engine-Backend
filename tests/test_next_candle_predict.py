...
def test_predict_last_day_and_next_hour():
    ...
    xgb.load_model('./src/KZ_project/dl_models/model_stack/BTC-USD_model_price_1h_feature_numbers_225.json')
...
if __name__ == '__main__':
    ...
    print(f'\nNext Candle Hourly Prediction for {config.SYMBOL} is: {next_candle_prediction}')
