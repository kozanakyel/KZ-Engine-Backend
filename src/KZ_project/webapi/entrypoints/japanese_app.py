...
japanese_router = APIRouter()


@japanese_router.post("/japanese")
async def post_japanese_response(symbol: str = SYMBOL):
    ...
    japanese_df = data_creator.get_candlesticks(is_complete=True)
